...
<div class="method-group online clearfix">
	<div class="method idx0">
		...
		<div class="method-content">
            ...
            Habbo Moedas são grátis! A cada 3 horas, iremos complementar e refil seus créditos até um lote de 3000, para garantir que você nunca se esgotam. Você não precisa nem mesmo ser registrado no hotel!
...
<div class="disclaimer" style="border: 0 !important;">
   ...
   Nunca combramos por moedas sempre serão de graça.<br />
