...
<a href="#" class="new-button compose"><b>Escribir</b><i></i></a> 

<div class="clearfix labels nostandard"> 
    <ul class="box-tabs"> 
        <li <?php if ($folder == 'inbox') { echo 'class="selected"'; } ?>><a href="#" label="inbox">Novas mensagens</a><span class="tab-spacer"></span></li> 
...
<div class="new-buttons clearfix"> 
	<div class="labels inbox-refresh"><a href="#" class="new-button green-button" label="<?php echo $folder; ?>" style="float: left; margin: 0"><b>Verificae novos emails</b><i></i></a></div> 
</div> 
<div style="clear: both; height: 1px"></div> 

<?php if ($folder == 'trash' && $messageCount >= 1) { ?>
    <div class="trash-controls notice">
        Mensagens pasta que estão nesta ha mais de 30 dias são excluídos automaticamente. <a href="#" class="empty-trash">Vaciar papelera</a>
    </div>
<?php } ?>
 
<div class="navigation"> 
<?php if ($folder == 'inbox') { ?><div class="unread-selector"><input type="checkbox" class="unread-only" <?php if ($unreadMode) { echo 'checked'; } ?>/> Marca como não lido.</div><?php } ?>
<?php echo $navigator; ?>
</div> 
	...
	else
	{
		...
		switch ($folder)
		{
			...
			case 'inbox':
				...
				if ($unreadMode)
				{
					echo 'Não há novas mensagens';
				}
				else
				{
					echo 'Não há mensagens recebidas';
				}
			...
			case 'sent':
				...
				echo 'Não há mensagens enviadas';
				break;
			   
			case 'trash':
			
				echo 'Não há mensagens na lixeira';
				break;
		}
