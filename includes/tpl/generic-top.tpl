...
<div id="header-container"> 
	<div id="header" class="clearfix"> 
       ...
       <div id="subnavi"> 
			...
			<?php if (LOGGED_IN) { ?>
<ul>
<li id="mygroups"><a <a href="#"><span>Bem vindo a OnlyCMS agora com Home use e abuse da CMS 2.0</span></a></li>
</ul>				 
			<?php } else { ?>
			<div class="clearfix">&nbsp;</div> 
                <p> 
				        <a href="%www%/client" id="enter-hotel-open-medium-link" target="client" onClick="HabboClient.openOrFocus(this); return false;" onmouseover="tooltip.show('Entrar..');" onmouseout="tooltip.hide();">Entrar no Hotel</a> 
                </p> 
			<?php } ?>
			</div> 
			<?php if (LOGGED_IN) { ?>
            ...
            <div id="to-hotel"> 
					    <a href="%www%/client" class="new-button green-button" target="uberClientWnd" onClick="HabboClient.openOrFocus(this); return false;"><b>Entra no Hotel</b><i></i></a> 
						
			<?php if ($users->HasFuse(USER_ID, 'fuse_housekeeping_login')) { ?>
								    <a href="%www%/manage/" class="new-button red-button" style="margin-right: 288px;"><b><?php include ("nombre.php"); ?> Manager</b><i></i></a> 
			<?php } ?>
                ...
                <form action="%www%/account/submit" method="post" id="login-form"> 
                    ...
                    <ul> 
                        <li> 
		                    ...
		                    <a href="#" id="login-submit-new-button" class="new-button" style="float: left; display:none"><b>Iniciar</b><i></i></a> 
                        ...
                        <li> 
                            ...
                            <label for="login-remember-me" class="left">Recordarme</label> 
                        </li> 
                    </ul> 
                </form> 
                <div id="subnavi-login-help" class="clearfix"> 
                    <ul> 
                        <li class="register"><a href="%www%/account/password/forgot" id="forgot-password"><span>¿Olvidaste tu contraseña?</span></a></li> 
                    	<li><a href="%www%/quickregister/start"><span>Reg&iacute;strate es gratis</span></a></li> 
                    </ul> 
                </div> 
<div id="remember-me-notification" class="bottom-bubble" style="display:none;"> 
	<div class="bottom-bubble-t"><div></div></div> 
	<div class="bottom-bubble-c"> 
					Ao selecionar 'Lembrar-me "sua sessão ficará autenticada neste computador até que você clique em' Sair '. Se estiver em um computador público evite usar esta função.
	</div> 
