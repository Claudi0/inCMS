...
<div class="box-tabs-container clearfix">
    <h2>Habbos</h2>
    <ul class="box-tabs">
        <li class="selected" id="tab-0-5-1"><a href="#">Buscar Habbos</a><span class="tab-spacer"></span></li>
    </ul>
</div>
...
<div id="avatar-habblet-list-search">
    ...
    <a class="new-button" id="avatar-habblet-search-button" href="#"><b>Buscar</b><i></i></a>
</div>
<br clear="all">
