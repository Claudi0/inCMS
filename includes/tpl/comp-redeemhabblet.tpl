    ...
    <div class="redeem-redeeming-text"><p class="redeeming-text">Inserte su codigo</p></div> 
...
<div class="redeem-redeeming"> 
    ...
    <div class="redeem-redeeming-button"><a href="#" class="new-button green-button redeem-submit"><b><span></span>Proceder</b><i></i></a></div> 
