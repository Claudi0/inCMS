...
<h2 class="title">Users Only, clique em algum.</h2>
...
while ($randomHabbo = mysql_fetch_assoc($getRandom))
{
	...
	<input type="hidden" id="active-habbo-image-' . $i . '" class="active-habbo-image" value="http://www.habbo.es/habbo-imaging/avatarimage?figure=' . clean($randomHabbo['look']) . '&direction=4&head_direction=4" />';
