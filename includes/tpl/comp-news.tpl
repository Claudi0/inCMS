	...
	<div class="cbb clearfix notitle "> 				
		...
		while ($n = mysql_fetch_assoc($getNews))
		{
	        ...
	        echo '<div class="topstory" style="background-image: url(' . clean($n['topstory_image']) . '); display: ' . $disp . ';"> 
	            ...
	            <p> 
	                <a href="' . WWW . '/articles/' . $n['id'] . '-' . $n['seo_link'] . '">Leer m&aacute;s</a> 
	            </p> 
	        </div>';
        ...
        echo '<div id="topstories-nav" style="display: none"><a href="#" class="prev">Anterior</a><span>1</span> / ' . $c . '<a href="#" class="next">Siguiente</a></div>';
		...
		?>
            ...
            <li class="last"><a href="/articles">Mas noticias &raquo;</a></li>            
        </ul>
</div> 
