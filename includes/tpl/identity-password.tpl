    ...
    <div class="settings-container clearfix">
        ...
        <h1>Ajustes de la cuenta</h1>
	        ...
	        <div id="back-link">
	        	...
	        	<a href="%www%/identity/avatars">Mis personajes</a> &raquo; <a href="%www%/identity/settings"> Ajustes de la cuenta</a> &raquo; Cambiar contraseña
        ...
        <div style="padding: 0 10px">
         ...
         <form action="%www%/identity/password_change" id="change-password" method="post">
            ...
            <div class="field field-password2">
              ...
              <label for="password2">Nueva Contraseña (otra vez)</label>

              <input type="password" id="password2" size="35" name="retypedNewPassword" value="" class="password-field" maxlength="32"/>

              <p class="help">Elige una contraseña que tenga al menos 6 caracteres y que incluya tanto letras como otros caracteres</p>
            ...
            <label>Teclea el código de la imagen.</label>
