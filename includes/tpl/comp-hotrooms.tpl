...
<style type="text/css">
.room-occupancy-1 { background-image: url('%www%/web-gallery/v2/images/rooms/room_icon_1.gif') !important; }
.room-occupancy-2 { background-image: url('%www%/web-gallery/v2/images/rooms/room_icon_2.gif') !important; }
.room-occupancy-3 { background-image: url('%www%/web-gallery/v2/images/rooms/room_icon_3.gif') !important; }
.room-occupancy-4 { background-image: url('%www%/web-gallery/v2/images/rooms/room_icon_4.gif') !important; }
.room-occupancy-5 { background-image: url('%www%/web-gallery/v2/images/rooms/room_icon_5.gif') !important; }
</style>
...
{	
	...
	<span class="room-enter">Entrar a la sala</span> 
...
<div class="clearfix"> 
<a href="#" class="room-toggle-more-data" id="room-toggle-more-data-h124">Ver Todas Las Salas</a> 
</div> 
