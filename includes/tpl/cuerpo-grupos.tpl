...
if(LOGGED_IN == TRUE && !$is_member && $groupdata['type'] !== "2" && $my_membership['is_pending'] !== "1")
{
	...
	{
		$viewtools = $viewtools . "Enviar petición";
	}
...
{
	$viewtools = $viewtools . "<a href=\"#\" id=\"reporting-button\" style=\"display: none;\">Mostrar la opción de Informar.</a>\n<a href=\"#\" id=\"stop-reporting-button\" style=\"display: none;\">Ocultar la opción de Informar.</a>";
}
...
<?php if($groupdata['type'] == "1"){ ?><img src='/web-gallery/images/status_exclusive_big.gif' alt='Grupo Moderado' title='Grupo Moderado'><?php } ?></h2>
    ...
    <ul class="box-tabs">
        <li class="selected"><a href="/groups/<?php echo $groupid; ?>/id">Página Principal</a><span class="tab-spacer"></span></li>
    </ul>
</div>
 ...
 <div style="display: block;">
  <div class="content-red">
   <div class="content-red-body">
    ...
    <span id="tag-invalid-message"><img src="./web-gallery/images/register/icon_error.gif"/> 'YoSoy' no válido</span>
   </div>
  </div>
