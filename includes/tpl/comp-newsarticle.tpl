        ...
        if(mysql_num_rows($getComments) == 0){ 
          ...
          <tr> 
            ...
            <td width="427px" align="right"> 
              <i>Por: <strong><a href="#">'.$userInfo['username'].'</a></strong> enviado el '.$Comments['posted_on'].'</i><br /><br /> 
            </td> 
          </tr>'; 
          } 
          echo '</table>'; 
...
<div class="fb-comments" data-href="http://habboholomax.no-ip.biz:8080" data-num-posts="1" data-width="500"></div>
