...
$password="hippie"; // Mysql password
$db_name="uberdb"; // Database name
...
mysql_connect("$host", "$username", "$password")or die("Imposible conectar con el servidor");
mysql_select_db("$db_name")or die("Imposible conectar con la DB");
...
<div class="cbb clearfix">
    ...
    <div class="box-content">
      ...
      <div class="right-column">
          <p><b>¿Como cambiamos la contraseña?</b></p>
