...
<link rel="stylesheet" href="%www%/web-gallery/static/styles/quickregister.css" type="text/css"/><script src="%www%/web-gallery/static/js/libs2.js" type="text/javascript"></script><script src="%www%/web-gallery/static/js/visual.js" type="text/javascript"></script><script src="%www%/web-gallery/static/js/libs.js" type="text/javascript"></script><script src="%www%/web-gallery/static/js/common.js" type="text/javascript"></script><script src="%www%/web-gallery/static/js/quickregister.js" type="text/javascript"></script>
...
<link rel="stylesheet" href="%www%/web-gallery/static/styles/quickregister.css" type="text/css" /><script src="%www%/web-gallery/static/js/quickregister.js" type="text/javascript"></script>
...
<!--[if IE 8]>
<link rel="stylesheet" href="%www%/web-gallery/static/styles/ie8.css" type="text/css" /><![endif]-->
<!--[if lt IE 8]>
<link rel="stylesheet" href="%www%/web-gallery/static/styles/ie.css" type="text/css" /><![endif]-->
<!--[if lt IE 7]>
<link rel="stylesheet" href="%www%/web-gallery/static/styles/ie6.css" type="text/css" /><script src="%www%/web-gallery/static/js/pngfix.js" type="text/javascript"></script><script type="text/javascript">
                ...
                <ul id="gender-choices">
                    <li>
                        ...
                        <span class="gender-choice">
                            Menino<br/><img alt="male" src="%www%/web-gallery/v2/images/registration/male_sign.png" width="36" height="47">
                        </span>
                    </li>
                    <li>
                        <span class="bgtop"></span>
                        <span class="bgbottom"></span>
                        <span class="gender-choice">
                            Menina<br/><img alt="female" src="%www%/web-gallery/v2/images/registration/female_sign.png" width="36" height="47">
                        </span>
                    </li>
                </ul>
            </div>
