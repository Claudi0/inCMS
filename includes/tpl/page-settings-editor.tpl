...
<div class="cbb clearfix settings"> 
 <h2 class="title">Configurasoes da conta.</h2> 
<div class="box-content"> 
<h1>Bem vindo a pagina de configurasao a sua conta ao lado esta o painel de configurasoes que voce pode fazer. Bom Jogo</h1>
