	<ul class="message-headers">
		...
		<li><b>De:</b> %from%</li>
		<?php if (!$sent) { ?><li><b>Para:</b> %to%</li><?php } ?>
	</ul>
    <div class="body-text">%body-text%</div>
    <div class="reply-controls">
        <div>
            <div class="new-buttons clearfix">
                <?php if (!$trashed) { ?><!--<a href="#" class="related-messages" id="rel-%message_id%" title="Ver toda a conversa"></a>--><?php } ?>
				<?php if ($trashed) { ?><a href="#" class="new-button undelete"><b>Não apagar</b><i></i></a><?php } ?>
