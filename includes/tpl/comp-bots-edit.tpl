...
header("Location: /bots/editar?exito");
}
...
<b>El BOT Respondera:<input name="contesta" type="text"   value="Hola Como Estas Bienvenido ala Sala" size="40"/><br>
