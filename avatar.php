...
?>
<?php
$email123 = $core->EscapeString($_SESSION['id']);
?>
		...
		<div id="content">
            ...
            <div id="user-info">
              ...
              <div>
                  ...
                  <div id="name"><?php echo $users->UserInfo('username'); ?></div>
		...
		$(document).ready(function() {
			$('.avatar').click(function()  {
				...
				$(container).fadeOut(500, function () {
					...
					$('.LastLogin').html('<?php echo $lang['last_login']; ?>: ' + LoginDate)
            ...
            <div id="first-avatar" class="CurrentAvatar">
                    ...
                    <div class="Mainavatar"><img src="http://www.habbo.com/habbo-imaging/avatarimage?figure=<?php echo $users->UserInfo("look"); ?>&size=lrg&direction=3&head_direction=3&gesture=sml&size=m" width="64" height="110"/></div>

                    <div id="first-avatar-info">

                        <div class="first-avatar-name" id="CharName"><?php echo $users->UserInfo("username"); ?></div>

                        <div class="first-avatar-lastonline">Last Access: <span title="30/05/12 14:36"><div class="LastLogin"><?php echo $users->UserInfo("lastaccess"); ?></div></span></div>
...
<form id="link-new-avatar" method="post" action="./includes/functions/addavatar.php">
				...
				<input type="hidden" name="email" id="email" value="<?php echo $email123; ?>" />
				...
				<div id="link-new-avatar"><div class="new-button" onclick="Add_Avatar.submit();">+ Add</div></div>
			</form>
            ...
            <div class="other-avatars">
                  ...
                  <ul>
				  <?php
			$userq = mysql_query("SELECT * FROM users WHERE mail = '".$email123."' ORDER BY last_online DESC LIMIT 50");
				...
				echo '<li class="even"><img src="http://www.habbo.com/habbo-imaging/avatarimage?figure='.$user["look"].'&size=s" figure="'.$user["look"].'" alt="'.$user["username"].'" class="avatar" lastlogin="'.@date("d-m-Y", $user["last_online"]).'" />
				 <div class="avatar-info">
                        ...
                        <div class="avatar-info-container">
                          ...
                          <div class="avatar-select"><a href="/me"><b>Play</b><i></i></a></div>
