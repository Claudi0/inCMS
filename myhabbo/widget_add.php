...
$result = mysql_query("SELECT * FROM groups_details ")
or die(mysql_error());
...
Event.observe("widget-<?php echo $row['id']; ?>-edit", "click", function(e) { openEditMenu(e, <?php echo $row['id']; ?>, "widget", "widget-<?php echo $row['id']; ?>-edit"); }, false);
		...
		<span class="header-left">&nbsp;</span><span class="header-middle">Mis Amigos (<span id="avatar-list-size">0</span>)</span><span class="header-right">&nbsp;</span></h3>
		</div>	
	</div>
...
<ul class="groups-list">
	...
	<li title="<?php echo $groupName; ?>" id="groups-list-<?php echo $userId; ?>-<?php echo $row['groupID']; ?>">
		<div class="groups-list-icon"><a href="/groups/<?php echo $row['groupID']; ?>/id"><img src="/habbo-imaging/badge/<?php echo $row['badge']; ?>.gif"/></a></div>
