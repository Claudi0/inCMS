	...
	<div id="warning">
		<noscript>
			<div id="javascript-warning">
				You Need JavaScript to Proceed to Next Step
			</div>
		</noscript>
	</div>
...
<form action="parte2.php" method="post" name="adminForm">
<div id="right">
	<div id="rightpad">
		<div id="step">
			<div class="t">
			...
			<div class="m">
				...
				<div class="far-right">
							...
							<div class="button1-left"><div class="next"><a onclick="validateForm( adminForm, 'preinstall' );" alt="Next">Next</a></div></div>
		...
		<div id="installer">
          ...
          <div class="m">
		<fieldset>
			Hello Welcome to CMS Installer. This Projj Known as CMS, CMS will be yours for Your Future
Habbo Hotel Server. I hope you Like it then Read the Steps of the Installation Tutorial.
Do not Forget to Put Your Data Properly Mysql, err If the Configuration Data from the hotel.
There is Magoe. Then you can set using the Control Panel. So You Ready? Let there!
		</fieldset>
					</div>
          <div class="b">
            <div class="b">
