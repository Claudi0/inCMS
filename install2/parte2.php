...
<div id="right">
	<div id="rightpad">
		<div id="step">
			...
			<div class="m">
				...
				<div class="far-right">
							...
							<div class="button1-left"><div class="next"><a class="next"><input type="submit"/></a></div></div>
		...
		<div id="installer">
          ...
          <div class="m">
		<fieldset>
<input type="text" name="host" id="host" value="Hotel Host"/>
</input>
<input type="text" name="user" id="user" value="PhPMyAdmin UserName"/>
</input>
<input type="text" name="pass" id="pass" value="PhPMyAdmin Password"/>
</input>
<input type="text" name="dbname" id="dbname" value="Hotel Database"/>
</input>
